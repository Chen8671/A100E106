...
<section>
  ...
  <section id="videos">
    <h3 class="h-sub">●動漫情報<span>（Anime information・㊝）</span></h3>
    <p>86.不存在的戰區</p>
    <p>《86－不存在的戰區－》（日語：86―エイティシックス―）是日本作家安里アサト[註 1]所撰寫的輕小說作品，しらび負責插畫，I-IV負責機器設定。小說由ASCII Media Works的電擊文庫出版。

      2017年7月，宣布將改編為漫畫版[1]。為小說第一卷的內容。除此之外尚有衍生漫畫「86 -Eighty Six- operation high school」，由染宮すずめ負責作畫。以及以小說第二卷內容為主的另一部改編漫畫「86 -Eighty Six- Run through the battlefront」，作畫為山﨑博也。</p>
